...
//    _complementColor = (HomePage._theme == 'dark')
//        ? const Color(0xFFBDBDBD)
//        : const Color(0xFF212121);
//    return Scaffold(
//      backgroundColor: (HomePage._theme == 'dark')
//          ? const Color(0xFF212121)
//          : const Color(0xFFBDBDBD),
//      body: SafeArea(
//        child: Column(
...
//              backgroundColor:
//                  (HomePage._theme == 'dark') ? Colors.black : Colors.white,
//              elevation: 3.0,
//              hoverElevation: 8.0,
//              onPressed: () {
//                _changeTheme();
...
//
//  const Game(this.sizeX, this.sizeY, this._color1, this._difficulty, {Key key})
//      : super(key: key);
//
//  @override
...
//  int _first = -1, _second = -1, _matchedCnt = 0, _dimension;
//  AnimationController _timerAnimation;
//  final List<Color> _randomColors = <Color>[],
//      _bckgrndColors = <Color>[],
//      _frgrndColors = <Color>[];
//  double _iconSize, _responsiveCoefficient;
//  String _finishTime = '', _completeMessage = '';
//
//  @override
//  void initState() {
//    super.initState();
...
//        //GAME FINISHED
//        _finishTime =
//            (_dimension * 5 * _timerAnimation.value).toStringAsPrecision(4);
//        _completeMessage = 'Completed in $_finishTime seconds.';
//        SharedPreferences _sp = await SharedPreferences.getInstance();
//        if (_sp.getString('${widget._difficulty.toLowerCase()}BestTime') ==
//                null ||
//            double.parse(_sp
//                    .getString('${widget._difficulty.toLowerCase()}BestTime')) >
//                double.parse(_finishTime)) {
//          if (_sp.getString('${widget._difficulty.toLowerCase()}BestTime') !=
//              null) {
//            _completeMessage =
...
//          }
//          _sp.setString(
//              '${widget._difficulty.toLowerCase()}BestTime', _finishTime);
//        }
...
//                  .animate(_timerAnimation),
//              child: Container(
//                width: MediaQuery.of(context).size.width,
//                height: 8.0,
//                color:
//                    (HomePage._theme == 'dark') ? Colors.white : Colors.black,
//              ),
//            ),
...
//                                  Image.asset('assets/veteran2.gif',
//                                      width: 280.0),
//                                ],
//                              ),
//                            ],
//                          ),
//                        if (widget._difficulty == 'CASUAL')
//                          Image.asset('assets/casual.gif'),
//                        if (widget._difficulty == 'EASY')
//                          Image.asset('assets/easy.gif', width: 280.0),
//                        const SizedBox(height: 36.0),
//                        Text(
//                          _completeMessage,
//                          textAlign: TextAlign.center,
...
//                              onTap: () {
//                                Navigator.of(context).pushReplacement(
//                                    MyRoute(builder: (_) => const HomePage()));
//                              },
//                              child: Container(
...
//                                          spreadRadius: 3.0,
//                                          color:
//                                              widget._color1.withOpacity(0.4),
//                                        ),
//                                      ],
//                                    ),
//                                    child: const Center(
...
//                                  .drive(Tween(begin: 1.0, end: 0.85)),
...
//                            Animation anim1, Animation anim2, Widget child) {
...
//                                          _responsiveCoefficient / 40),
//                                      contentPadding: EdgeInsets.all(
//                                          _responsiveCoefficient / 20),
...
//                                                            49),
//                                                width:
//                                                    _responsiveCoefficient / 4,
//                                                decoration: ShapeDecoration(
//                                                  color: (HomePage._theme ==
//                                                          'dark')
//                                                      ? Colors.black26
//                                                      : Colors.white24,
//                                                  shape:
